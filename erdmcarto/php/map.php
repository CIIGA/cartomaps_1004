...
if(isset($_POST['saveclave'])){
    ...
    if(($plz == 25) or ($plz == 2030) or ($plz == 2040)){
...
<!--
    ...
    <h6 style="text-shadow: 0px 0px 1px #717171;" class="small">Busqueda por numero de cuenta o nombre de propietario en mapa <?php// echo $mapa['nombreMapa'] ?>.</h6>    
    </div>
    </form>
-->
<!--******************************************************************************************-->
...
<!--
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    <div class="container-fluid">
                        ...
                        <?php// if(isset($_GET['mp'])){ ?>
                            <h6 style="text-shadow: 0px 0px 2px #717171;"><?php// echo 'Mapa: '.$mapa['nombreMapa'] ?></h6>
                        <?php// } ?>    
...
<script>
    function initialize() {
  const fenway = { lat:<?php echo $direccion['Latitud']; ?>, lng:<?php echo $direccion['Longitud']; ?>};
...
<script>
    function initialize() {
  var coord = {lat:<?php echo $direccion['Latitud']; ?> ,lng:<?php echo $direccion['Longitud']; ?>};        
  const fenway = { lat:<?php echo $direccion['Latitud']; ?>, lng:<?php echo $direccion['Longitud']; ?>};
